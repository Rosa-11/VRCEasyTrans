...
一个基于 C++ Qt 框架的高性能实时语音识别和翻译工具，专为 VRchat 等虚拟现实社交平台设计。
...
· 🎮 VR 原生支持 - 通过 OSC 协议与 VRchat 无缝集成
· 🎨 现代界面 - 深色主题，直观易用

📊 性能对比

特性 PyQt6 (Python) VoiceBridgeVR (C++ Qt) 提升
